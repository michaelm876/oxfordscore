<x-app-layout>
    ...
    <section class="mb-8">
        <div class="flex items-center justify-between">
            <h3 class="font-semibold text-lg text-gray-800">Editing Hip Submission ID: {{ $hip->id }}</h3>
            <div class="flex gap-6">
                <a title="Back to record" href="{{ route('hips.show', $hip) }}" class="text-gray-600 hover:text-gray-900">
    ...
    <section class="mb-8">
        <form method="POST" action="{{ route('hips.update', $hip) }}">
            @csrf
            @method('PATCH')
            <fieldset class="p-4 bg-slate-50 mb-8">
                ...
                <div class="flex gap-4 mb-4 items-center flex-wrap">
                    ...
                    <input type="text" name="name" id="name" value="{{ $hip->name }}" class="grow max-w-xs cursor-text border-gray-300 focus:border-sky-400 focus:ring-sky-400 rounded-md shadow-sm">
                    @error('name')
                ...
                <div class="flex gap-4 mb-4 items-center flex-wrap">
                    ...
                    <input type="text" name="chi" id="chi" value="{{ $hip->chi }}" class="grow max-w-xs cursor-text border-gray-300 focus:border-sky-400 focus:ring-sky-400 rounded-md shadow-sm">
                    @error('chi')
                ...
                <div class="flex gap-4 mb-4 items-center flex-wrap">
                    ...
                    <input type="date" name="dob" id="dob" value="{{ $hip->dob->format('Y-m-d') }}" class="grow max-w-xs cursor-text border-gray-300 focus:border-sky-400 focus:ring-sky-400 rounded-md shadow-sm">
                    @error('dob')
                ...
                <div class="flex gap-4 mb-4 items-center flex-wrap">
                    ...
                    <input
                        ...
                        {{ $hip->surgery_cancelled ? 'checked' : null }}
                    >
                ...
                <div class="flex gap-4 mb-4 items-center flex-wrap">
                    ...
                    <input type="text" name="surgery_type" id="surgery_type" value="{{ $hip->surgery_type }}" class="grow max-w-xs cursor-text border-gray-300 focus:border-sky-400 focus:ring-sky-400 rounded-md shadow-sm">
                    @error('surgery_type')
                ...
                <div class="flex gap-4 mb-4 items-center flex-wrap">
                    ...
                    <input type="date" name="surgery_date" id="surgery_date" value="{{ $hip->surgery_date?->format('Y-m-d') }}" class="grow max-w-xs cursor-text border-gray-300 focus:border-sky-400 focus:ring-sky-400 rounded-md shadow-sm">
                    @error('surgery_date')
                ...
                <div class="flex gap-4 mb-4 items-center flex-wrap">
                    ...
                    <input
                        ...
                        id="surgery_notfv"
                        class="cursor-pointer border-gray-300 focus:border-sky-400 focus:ring-sky-400 rounded-md shadow-sm"
                        {{ $hip->surgery_notfv ? 'checked' : null }}
                    >
                    @error('surgery_notfv')
                    <p class="text-red-700 font-semibold">Error.</p>
                    @enderror
                ...
                <div class="flex gap-4 mb-4 items-center flex-wrap">
                    ...
                    @foreach( $consultants as $consultant )
                        <option {{ $hip->consultant?->id == $consultant->id ? 'selected' : null }} value="{{ $consultant->id }}">{{ $consultant->name }}</option>
                    @endforeach
                    </select>
                    @error('consultant_id')
                ...
                <div class="flex gap-4 mb-4 items-center flex-wrap">
                    ...
                    <select name="joint" id="joint" class="grow max-w-xs cursor-pointer border-gray-300 focus:border-sky-400 focus:ring-sky-400 rounded-md shadow-sm">
                        <option value="">Please Select</option>
                        <option {{ $hip->joint == 'Left' ? 'selected' : null }}>Left</option>
                        <option {{ $hip->joint == 'Right' ? 'selected' : null }}>Right</option>
                        <option {{ $hip->joint == 'Bilateral' ? 'selected' : null }}>Bilateral</option>
                    </select>
                    @error('joint')
                    <p class="text-red-700 font-semibold">Please select an option.</p>
                    @enderror     
                ...
                <div class="flex gap-4 mb-4 items-center flex-wrap">
                    ...
                    <select name="type" id="type" class="grow max-w-xs cursor-pointer border-gray-300 focus:border-sky-400 focus:ring-sky-400 rounded-md shadow-sm">
                        <option value="">Please Select</option>
                        <option {{ $hip->type == 'Pre Operation' ? 'selected' : null }}>Pre Operation</option>
                        <option {{ $hip->type == 'Year 1 Post Operation' ? 'selected' : null }}>Year 1 Post Operation</option>
                        <option {{ $hip->type == 'Year 5 Post Operation' ? 'selected' : null }}>Year 5 Post Operation</option>
                        <option {{ $hip->type == 'Year 10 Post Operation' ? 'selected' : null }}>Year 10 Post Operation</option>
                        <option {{ $hip->type == 'Subsequent Years' ? 'selected' : null }}>Subsequent Years</option>
                    </select>
                    @error('type')
                    <p class="text-red-700 font-semibold">Please select an option.</p>
                    @enderror     
