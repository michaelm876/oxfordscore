...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Hip>
 */
class HipFactory extends Factory
{
    /**
    ...
    public function definition()
    {
        return [
            ...
            'socks' => $this->faker->numberBetween($min = 0, $max = 5),
            'spasms' => $this->faker->numberBetween($min = 0, $max = 5),
